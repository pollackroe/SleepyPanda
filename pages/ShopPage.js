    ...
    <View style={styles.container}>
      ...
      <ImageBackground source={backgroundImage} style={styles.backgroundImage}>
        <Text style={styles.text}>
          View the pandas you have collected so far!
        </Text>
        <SafeAreaView style={styles.container}>
          <ScrollView style={styles.scrollView}>
            <View style={styles.framesPerRow}>
              {
                <ImageBackground source={frameImage} style={styles.frame}>
                  <View style={styles.panda}>
                    <Image source={pandaImage} style={styles.panda} />
                  </View>
                </ImageBackground>
              }
              {
            ...
            <View style={styles.framesPerRow}>
              {
                <ImageBackground source={frameImage} style={styles.frame}>
                  <View style={styles.panda}>
                    <Image source={mysteryImage} style={styles.panda} />
                  </View>
                </ImageBackground>
              }
              {
